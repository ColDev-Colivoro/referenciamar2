      ...
      <CardContent className="space-y-5">
            ...
            {reports.map((report, index) => (
              <div key={index} className="border border-gray-200 rounded-lg p-3 space-y-1 bg-white shadow-sm">
                <div className="flex justify-between items-start">
                  ...
                  <Button size="sm" variant="ghost" className="h-9 w-9 text-primary hover:bg-primary/10 rounded-full">
        ...
        <div className="bg-primary/10 p-3 rounded-lg border border-border text-sm">
          ...
          <Button
            size="sm"
            variant="outline"
            className="mt-3 w-full text-xs font-semibold border-border text-primary hover:bg-primary/10 rounded-md bg-transparent"
          >
